...
Marked.use({ extensions : [justifiedParagraphs, definitionListsMultiLine, definitionListsSingleLine, forcedParagraphBreaks,
	nonbreakingSpaces, superSubScripts, mustacheSpans, mustacheDivs, mustacheInjectInline, glossaryEntries] });
...
// Given a string representing an HTML element, extract all of its properties
// (id, class, style, and other attributes)
