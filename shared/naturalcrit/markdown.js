...
Marked.use({ extensions : [indexAnchors, justifiedParagraphs, definitionListsMultiLine, definitionListsSingleLine,
	forcedParagraphBreaks, nonbreakingSpaces, superSubScripts, mustacheSpans, mustacheDivs, mustacheInjectInline] });
