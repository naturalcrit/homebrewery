...
test('Check Index Anchors in custom renderer', function() {
	...
	const rendered = Markdown.render(source);
	expect(rendered).toBe('<p><a href="#hereweare" subjectHeading="there" entry="hereweare"></a>Welcome traveler from an antique land. Please sit and tell us of what you have seen. The unheard of monsters, who slither and bite. <a href="#herewewere" subjectHeading="there" entry="hereWeWere"></a>Tell us of the wondrous items and and artifacts you have found, their mysteries yet to be unlocked. Of the vexing vocations and surprising skills you have seen.<a href="#hereweshallbe" subjectHeading="there" entry="here We Shall be"></a></p>\n');
});
